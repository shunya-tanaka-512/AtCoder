import pytest
from typical90d import get_cell_totals


@pytest.mark.parametrize(
    "h, w, cell_nums, expected",
    [
        (
            4,
            4,
...
def test_get_cell_totals(h: int, w: int, cell_nums: list, expected: list):
    assert get_cell_totals(h, w, cell_nums) == expected
